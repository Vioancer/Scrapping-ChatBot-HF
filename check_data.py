...
# Check if 'label' is a dictionary and contains the key 'features'
if isinstance(loaded_data, dict) and 'Home page' in loaded_data['label']:
    ...
    if context is not None and label is not None:
        ...
        print("Invalid or missing data in 'features' label.")
else:
